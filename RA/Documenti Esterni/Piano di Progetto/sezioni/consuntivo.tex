...
%CONTINUARE A SISTEMARE TABELLE E FARE PROSPETTO ORARIO
\pagebreak
\subsection{Consuntivo totale complessivo}
\subsubsection{Prospetto orario}
%FARE PROSPETTO ORARIO
...
%FARE PROSPETTO ORARIO
\subsubsection{Prospetto economico}
La seguente tabella riporta i costi derivati dalle ore rendicontate impiegate per ogni ruolo, partendo dalla fase di {Progettazione architetturale} inclusa.
\begin{center}
    \begin{table}[ht!]
        \centering
