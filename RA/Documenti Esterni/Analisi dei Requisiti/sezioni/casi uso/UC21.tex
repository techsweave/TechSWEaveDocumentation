...
%     \item \textbf{Scenario Principale:} il cliente inserisce negli appositi spazi i dati per completare l'indirizzo di spedizione oppure clicca il pulsante per inserirli automaticamente se è il medesimo di quello di fatturazione.
% \end{itemize}
\subsubsection{UC21.1: Inserimento dei dati del pagamento}
\label{sec:UC21.1}
\begin{itemize}
