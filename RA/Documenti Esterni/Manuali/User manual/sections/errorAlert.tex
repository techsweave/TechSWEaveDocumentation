...
\begin{itemize}
    ...
    \item if possible the browser console log (reachable by pressing {\fontfamily{qcr}\selectfont 'F12'} and opening the console tab or with the shurtcut {\fontfamily{qcr}\selectfont 'ctrl+shift+k'})
