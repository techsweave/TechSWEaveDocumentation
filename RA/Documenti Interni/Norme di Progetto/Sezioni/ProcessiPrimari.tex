...
\subsubsection{Avvio}
Durante quest'attività il gruppo effettua l'analisi e valutazione dei requisiti presenti nelle varie proposte di capitolato\textsubscript{\textbf{G}}, sotto la supervizione del \textit{Responsabile di Progetto}\textsubscript{\textbf{G}}. Tale valutazione termina con l'accettazione o meno di ogni singola proposta.
\subsubsubsection{Studio di Fattibilità}
Lo Studio di Fattibilità viene redatto dagli Analisti ed indica il risultato dell'attività di valutazione di ogni capitolatoG proposto. Tra le informazioni da esso fornite sono presenti:
\begin{itemize}
...
Il gruppo conduce una revisione dei requisiti di acquisizione, andando successivamente a definire un piano di gestione del progetto in grado di tutelare la qualità del prodotto software che si va a concretizzare. È durante lo svolgimento di questa attività che ha inizio il rapporto di collaborazione tra il gruppo ed il Proponente, la cui corretta gestione garantisce una più approfondita comprensione delle sue richieste e, di conseguenza, una più precisa determinazione dei vincoli da porre sui processi e sui requisiti del prodotto. Questa attività si concretizza attraverso la redazione del \textit{Piano di Progetto}.
...
\subsubsubsection{Scopo}
L'attività di progettazione ha come scopo la ricerca di una soluzione architetturale in grado di soddisfare i requisiti degli \textit{stakeholders}\textsubscript{\textbf{G}}, esposti nel documento \textit{Analisi dei Requisiti v3.0.0}.
