...
\begin{itemize}
    ...
    \item redigere lo \textit{Studio di Fattibilità v1.0.0} e l’\textit{Analisi dei Requisiti v4.0.0}.
\end{itemize}
\textbf{Progettista}\\
...
\end{itemize}
\textbf{Verificatore}\\
Il \textit{Verificatore}\textsubscript{\textbf{G}} si occupa di controllare il prodotto del lavoro svolto dagli altri membri del gruppo, sia esso codice o documentazione. Per le correzioni si affida agli standard definiti nelle \textit{Norme di Progetto v4.0.0}.\\
I suoi compiti sono i seguenti:
\begin{itemize}
    \item ispezionare i prodotti in fase di revisione, avvalendosi delle tecniche e degli strumenti definiti nelle \textit{Norme di Progetto v4.0.0};
    \item segnalare eventuali difetti o errori del prodotto in esame;
    \item redigere la parte retrospettiva del \textit{Piano di Qualifica v4.0.0}, il quale descrive e chiarisce le verifiche e le prove effettuate.
\end{itemize}
...
\end{itemize}
Per poter rispettare e attuare quanto appena descritto il gruppo \textit{TechSWEave} controllerà costantemente l'andamento dei processi attraverso il cruscotto di valutazione posto all'interno del \textit{Piano di Qualifica v4.0.0}.
