...
\begin{center}
    ...
    \begin{longtable}[!h]{p{50px} p{50px}}
        ...
        \hyperref[tab:RequisitiFunzionali]{R33F}   & Capitolato                                     \\
        \hyperref[tab:RequisitiFunzionali]{R33.1F} & \hyperref[sec:UC37.1]{UC37.1}                  \\
        \hyperref[tab:RequisitiFunzionali]{R33.2F} & \hyperref[sec:UC37.2]{UC37.2}                  \\



        % END TABELLA REQUISITI FUNZIONALI

        % START TABELLA REQUISITI QUALITÀ
