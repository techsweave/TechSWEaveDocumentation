          ...
          \begin{itemize}
              ...
              \item si registra attraverso Amazon Cognito, inserendo i seguenti dati:
                    \begin{itemize}
                        ...
                        \item data di nascita (\hyperref[sec:UC9.5]{\underline{UC9.5}});
                        \item numero di telefono (\hyperref[sec:UC9.6]{\underline{UC9.6}});
                        \item indirizzo (\hyperref[sec:UC9.7]{\underline{UC9.7}});
                    \end{itemize}
...
\subsubsection{UC9.5: Inserimento data di nascita}
\label{sec:UC9.5}
\begin{itemize}
    \item \textbf{Descrizione:} l'utente inserisce la data di nascita per registrarsi;
    \item \textbf{Attore Primario:} utente generico;
    \item \textbf{Attore Secondario:} Amazon Cognito;
    \item \textbf{Precondizione:} l'utente ha inserito lo username (\hyperref[sec:UC9.3]{\underline{UC9.3}});
    \item \textbf{Input:} stringa con il cognome;
...
\subsubsection{UC9.6: Inserimento numero di telefono}
\label{sec:UC9.6}
\begin{itemize}
    \item \textbf{Descrizione:} l'utente inserisce il numero di telefono per registrarsi;
    \item \textbf{Attore Primario:} utente generico;
    \item \textbf{Attore Secondario:} Amazon Cognito;
    \item \textbf{Precondizione:} l'utente ha inserito il nome (\hyperref[sec:UC9.1]{\underline{UC9.1}});
    \item \textbf{Input:} stringa con il cognome;
...
\subsubsection{UC9.7: Inserimento indirizzo}
\label{sec:UC9.7}
\begin{itemize}
    \item \textbf{Descrizione:} l'utente inserisce l'indirizzo per registrarsi;
    \item \textbf{Attore Primario:} utente generico;
    \item \textbf{Attore Secondario:} Amazon Cognito;
    \item \textbf{Precondizione:} l'utente ha inserito il nome (\hyperref[sec:UC9.5]{\underline{UC9.5}});
    \item \textbf{Input:} stringa con il cognome;
    \item \textbf{Postcondizione:} l'utente ha inserito il cognome.
\end{itemize}