...
\begin{center}
    ...
    \begin{longtable}[!h]{p{50px} p{245px} p{75px} p{50px}}
        ...
        \textbf{R7F}                          & L'utente deve poter cercare i prodotti tramite il titolo dei prodotti stessi                        & Obbligatorio             & \hyperref[sec:UC6]{UC6}                        \\
        ...
        R11.5F                                & L'utente deve poter inserire il proprio data di nascita                                             & Obbligatorio             & \hyperref[sec:UC9.5]{UC9.5}                    \\
        R11.6F                                & L'utente deve poter inserire il proprio numero di telefono                                          & Obbligatorio             & \hyperref[sec:UC9.6]{UC9.6}                    \\
