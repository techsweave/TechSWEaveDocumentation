...
\begin{itemize}
    ...
    \item Discussione sulla struttura degli eventi, approccio in grado di rendere più indipendenti i microservizi;
...
\begin{center}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{p{200px} p{200px}}
            ...
            VE\_2021\_05\_21.1                 & Utilizzo di Amazon SNS, SQS per comunicazioni tra microservizi. Utilizzo facoltativo e discrezionale di Amazon SES.\\
            VE\_2021\_05\_21.2                 & Utilizzo di Amazon EventBridge come servizio bus di eventi serverless.\\
            VE\_2021\_05\_21.3                 & Utilizzo di codice SKU per il versionamento dei prodotti.
        \end{tabular}
    \end{table}
\end{center}
