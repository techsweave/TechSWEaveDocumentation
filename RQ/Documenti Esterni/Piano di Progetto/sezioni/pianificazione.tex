...
\begin{figure}[!ht]
    \caption{Diagramma di Gantt dell'incremento 1}
    \vspace{5px}
...
\subsubsubsection{Diagramma di Gantt}
\begin{figure}[!ht]
    \caption{Diagramma di Gantt dell'incremento 2}
    \vspace{5px}
...
\subsubsubsection{Diagramma di Gantt}
\begin{figure}[!ht]
    \caption{Diagramma di Gantt dell'incremento 3}
    \vspace{5px}
...
\subsubsubsection{Diagramma di Gantt}
\begin{figure}[!ht]
    \caption{Diagramma di Gantt dell'incremento 4}
    \vspace{5px}
...
\subsubsubsection{Diagramma di Gantt}
\begin{figure}[!ht]
    \caption{Diagramma di Gantt dell'incremento 5}
    \vspace{5px}
...
\begin{figure}[!ht]
    ...
    \vspace{5px}
    \includegraphics[scale=0.3]{../../../Images/Diagrammi/Gantt/validazione_v3.png}
    \centering
\end{figure}