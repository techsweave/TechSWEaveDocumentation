...
\begin{center}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{p{160px} p{90px} p{70px} p{55px} p{45px}}
            ...
            Approvazione del documento per RQ                                                                       & Urbani Simone     & Responsabile   & 2021-07-01    & 3.0.0             \\
            Verifica e revisione completa del documento \newline(Verificatore: Tito Scutari)                        & Nicolò Giaccone   & Responsabile   & 2021-06-30    & 2.2.0             \\
