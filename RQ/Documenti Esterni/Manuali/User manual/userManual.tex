...
\begin{center}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{p{150px} p{90px} p{80px} p{60px} p{45px}}
            ...
            Document validation                                  & Marco Barbaresco  & Manager       & 2021-07-04    & 1.0.0            \\
            Document verification\newline(Verifier: Manuel Varo) & Varo Manuel       & Verifier      & 2021-07-02    & 0.8.0            \\

            %righe commentate da usare come base
...
\input{sections/genricUserInstruction.tex}
\input{sections/clientInstruction.tex}
\input{sections/vendorInstructions.tex}
