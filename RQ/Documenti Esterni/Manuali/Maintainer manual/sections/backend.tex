...
\end{figure}
The diagram represents the sequence of operations necessary to create a product, the \textit{isVendor()} method is responsible for checking that the user who accesses the creation of the product is a seller and therefore has access to this functionality.
\pagebreak
...
\end{figure}
The diagram represents the sequence of operations necessary for the use of filters on tags, this feature can be used by any user.
\pagebreak
