...
\begin{itemize}
    ...
    \item \textbf{Competitors:} I gruppi \textit{SWEException}, \textit{Not Only Students} e \textit{OmicronSWE}. Questi gruppi, appartenenti al primo lotto, lavorano al progetto \textit{Emporio\(\lambda\)ambda}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Email}
          ...
          \end{center}. Le e-mail hanno un tono formale: ci si rivolge al destinatario dando del lei. L'oggetto della mail deve essere conciso ed autoesplicativo così da favorire una comunicazione veloce.
    \item \textbf{Slack}
