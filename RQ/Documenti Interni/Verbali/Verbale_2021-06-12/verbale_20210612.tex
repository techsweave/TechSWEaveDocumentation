...
\rhead{\large Verbale Interno del 2021-06-12}
%\rfoot{\thepage}
...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{20px}
        \textbf{\huge\textcolor{logo}{Verbale Interno del 2021-06-12}}\\
        \vspace{10px}
        \textcolor{logo}{\hrulefill}\\
        \vspace{40px}
...
\begin{itemize}
    \item Data e ora: 2021-06-12 ore 09:30-10:00.
...
Durante l'incontro sono state riepilogate le attività concluse dai vari membri del gruppo e sono stati distribuiti nuovi ruoli e compiti agli stessi.
\section{Verbale della riunione}
\begin{itemize}
    \item Allineamento sullo stato delle attività di progetto;
    \item Assegnazione nuovi ruoli;
...
\begin{center}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{p{200px} p{200px}}
            ...
            VI\_2021\_06\_12.1                 & Assegnati i ruoli fino all'incontro della \textit{Product Baseline}. \\
            VI\_2021\_06\_12.2                 & Assegnati i task fino all'incontro della \textit{Product Baseline}.  \\
        \end{tabular}
    \end{table}
\end{center}
\end{document}
