...
\rhead{\large Verbale Interno del 2021-07-28}
%\rfoot{\thepage}
...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{20px}
        \textbf{\huge\textcolor{logo}{Verbale Interno del 2021-07-28}}\\
        \vspace{10px}
        \textcolor{logo}{\hrulefill}\\
        \vspace{40px}
        ...
        \begin{tabular}{p{100px} | p{100px}}
            ...
            \textbf{Responsabile} & Nicolò Giacccone                                                           \\
...
\begin{itemize}
    \item Data e ora: 2021-07-28 ore 09:30-10:00.
...
Durante l'incontro si è discusso l'esito della \textit{Product Baseline} ed è stata fissato un colloquio con il proponente \textit{Red Babel}.
\section{Verbale della riunione}
\begin{itemize}
    \item Discussione riguardo l'esito della \textit{Product Baseline};
    \item Fissato il colloquio con il proponente.
\end{itemize}
\section{Resoconto}
\begin{center}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{p{200px} p{200px}}
            ...
            VI\_2021\_07\_28.1                 & Fissato il colloquio con il proponente \textit{Red Babel} per il giorno 2021-08-03. \\
        \end{tabular}
    \end{table}
\end{center}
\end{document}
