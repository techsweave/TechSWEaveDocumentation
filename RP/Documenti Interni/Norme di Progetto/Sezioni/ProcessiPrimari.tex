...
\subsubsection{Scopo}
La fase di progettazione ha come scopo la ricerca di una soluzione architetturale in grado di soddisfare i requisiti degli \textit{stakeholders}\textsubscript{\textbf{G}}, esposti nel documneto \textit{Analisi dei Requisiti v1.0.0}.
