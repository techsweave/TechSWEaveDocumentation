...
\item Gestire e salvaguardare la documentazione, controllando che sia corretta, verificata e approvata, semplificando il suo reperimento;
...
\item Se ritiene il compito troppo complesso, lo suddivide in più sottocompiti;
...
\item \textbf{Analisi del compito}: il Responsabile stima la complessità del compito appena identificato, dividendolo in più sottcompiti se lo ritiene troppo oneroso. Individua poi uno o più assegnatari e una data di scadenza entro la quale il lavoro dovrà essere terminato;
