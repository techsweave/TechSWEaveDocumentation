...
\begin{center}
    ...
    \begin{longtable}[!h]{p{50px} p{245px} p{75px} p{50px}}
        ...
        \textbf{R18F}                         & L'utente deve poter contattare il venditore                                                                & Opzionale             & \hyperref[sec:UC18]{UC18}                    \\
        ...
        \textbf{R25F}                         & Il venditore deve poter contattare un cliente                                                              & Opzionale             & \hyperref[sec:UC25]{UC25}                    \\
...
\begin{center}
    ...
    \begin{longtable}[!h]{p{50px} p{200px} p{100px} p{50px}}
        ...
        \textbf{R3Q}                          & La documentazione deve essere scritta in lingua inglese                                                                                                            & Obbligatorio             & Capitolato     \\
...
\begin{center}
    ...
    \begin{longtable}[!h]{p{50px} p{200px} p{100px} p{50px}}
        ...
        \textbf{R11V}                         & Devono essere applicate tecniche di \textit{Search Engine Optimization}\textsubscript{\textbf{G}} nella homepage, nella pagina della lista e in quella di dettaglio dei prodotti & Obbligatorio & Capitolato \\
