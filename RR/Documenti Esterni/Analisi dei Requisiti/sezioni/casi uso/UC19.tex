\subsection{UC19: Checkout}
        \label{sec:UC19}
            ...
            \end{figure}
                ...
                \item \textbf{Precondizione:} il cliente si trova nell carrello (\hyperref[sec:UC12]{\underline{UC12}}) e ha già inserito almeno un prodotto oppure nella pagina del prodotto (\hyperref[sec:UC5]{\underline{UC5}});
