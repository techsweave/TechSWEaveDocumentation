\section{Casi d'uso}
    ...
    \subsection{Elenco dei casi d'uso}
        ...
        \begin{itemize}
            ...
            \end{itemize}
        \end{itemize}
        \subsection{UC7: Prima registrazione}
        \label{sec:UC7}
        \begin{itemize}
            ...
            \end{itemize} 
        \end{itemize}
        \subsection{UC8: Gestione del carrello}
        \begin{figure}[!ht]
        ...
        \begin{itemize}
            ...
            \item \textbf{Scenario Principale:}
                ...
                \end{itemize}
        \end{itemize}
        \subsubsection{UC8.1: Visualizzazione dei prodotti inseriti}
        \label{sec:UC8.1}
        \begin{itemize}
        ...
        \end{itemize}
        \subsubsection{UC8.3: Modifica della quantità di uno o più prodotti}
        \begin{itemize}
        ...
        \subsection{UC13: Visualizzazione profilo}
        \label{sec:UC13}
        \begin{itemize}
        ...
        \end{itemize}
        \subsection{UC17: Visualizza gli ordini effettuati}
        \label{sec:UC17}
        \begin{itemize}
        ...
        \label{sec:UC18}
            ...
            \label{sec:UC18.2}
                ...
                \end{itemize}
            \subsubsection{UC18.3: Reindirizzamento al servizio di pagamento esterno}
            \label{sec:UC18.3}
                \begin{itemize}
                    ...
                    \end{itemize}
                \end{itemize}
            \subsubsection{UC18.4: Errore di pagamento}
            \label{sec:UC18.4}
                \begin{itemize}
...
\subsection{UC23: Gestione dei prodotti}
        \label{sec:UC23}
        \begin{figure}[!ht]
        ...
        \begin{itemize}
            ...
            \item \textbf{Scenario Principale:} 
                ...
                \end{itemize}
        \end{itemize}
        \subsubsubsection{UC23.1: Aggiunta di un prodotto}
        \begin{itemize}
            ...
            \item \textbf{Scenario Principale:} 
                ...
                \end{itemize}
        \end{itemize}
        \subsubsubsection{UC23.2: Modifica di un prodotto}
        \begin{itemize}
            ...
            \item \textbf{Scenario Principale:} 
                ...
                \end{itemize}
        \end{itemize}
        \subsubsubsection{UC23.3: Rimozione di un prodotto}
        \begin{itemize}
        ...
        \subsubsection{UC24: Gestione delle categorie}
        \label{sec:UC24}
        \begin{figure}[!ht]
        ...
        \begin{itemize}
            ...
            \item \textbf{Scenario Principale:} 
                ...
                \end{itemize}
        \end{itemize}
        \subsubsubsection{UC24.1: Aggiunta di una categoria}
        \begin{itemize}
            ...
            \item \textbf{Scenario Principale:} 
                ...
                \end{itemize}
        \end{itemize}
        \subsubsubsection{UC24.2: Rimozione di una categoria}
        \begin{itemize}
