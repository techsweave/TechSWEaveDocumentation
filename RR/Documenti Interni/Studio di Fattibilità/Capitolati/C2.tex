...
\begin{itemize}
    \item \textbf{EmporioLambda-frontend:} si occupa di gestire le pagine richieste dall’utente. Il compito di questo modulo è pre-renderizzare le pagine in HTML sul server ad ogni richiesta. Dovrà essere implementato utilizzando Next.js\textsubscript{\textbf{G}} e TypeScript\textsubscript{\textbf{G}};
