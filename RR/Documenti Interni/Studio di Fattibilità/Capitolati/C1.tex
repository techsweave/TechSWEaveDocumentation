...
La finalità del progetto è quella di creare un server completo di \texttit{UI} per la gestione delle stanze e delle postazioni e un'applicazione mobile per Android e iOS.
