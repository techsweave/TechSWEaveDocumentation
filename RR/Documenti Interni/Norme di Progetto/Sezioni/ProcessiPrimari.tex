...
\\Questo documento è strutturato nel modo seguente:
\begin{itemize}
    \item \textbf{Qualità di processo}: vengono individuati dei processi dagli standard, stabiliti degli obiettivi, fissate delle procedure per attuarli e delle metriche\textsubscript{\textbf{G}} per misurarli;
...
\begin{itemize}
    \item \textbf{Visual Studio Code}: Un \textit{IDE}\textsubscript{\textbf{G}} \textit{(Integrated Development Environment)} adatto alla stesura del codice di diversi linguaggi di programmazione, oltre che all'ootima integrazione con Git\textsubscript{\textbf{G}}.
