...
\begin{itemize}
    \item \textbf{Visual Studio Code}: un editor adatto alla stesura del codice di diversi linguaggi di programmazione, e predisposto ad un'ottima integrazione con Git\textsubscript{\textbf{G}};
