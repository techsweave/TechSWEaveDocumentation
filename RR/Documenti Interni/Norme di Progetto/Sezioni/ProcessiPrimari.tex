...
\begin{itemize}
    \item \textbf{Visual Studio Code}: editor adatto alla stesura del codice di diversi linguaggi di programmazione e predisposto all'integrazione con Git\textsubscript{\textbf{G}};
    \item \textbf{Draw.io}: piattaforma online utile alla creazione di diagrammi UML;
    \item \textbf{Next.js}: framework web di sviluppo front-end React open source che abilita funzionalità come il rendering lato server e la generazione di siti web statici per applicazioni web basate su React. Fornisce possibilità di integrazione con Typescript;
    ...
    \item \textbf{Serverless Framework}: framework Web gratuito e open source scritto utilizzando Node.js. Serverless è il primo framework sviluppato per la creazione di applicazioni su AWS Lambda;
    ...
    \item \textbf{Amazon DynamoDB}: servizio di database NoSQL facente parte dei servizi offerti da Amazon Web Services;
